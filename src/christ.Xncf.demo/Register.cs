...
using christ.Xncf.demo.Functions;
...
using christ.Xncf.demo.Services;
using christ.Xncf.demo.Models.DatabaseModel.Dto;
...
namespace christ.Xncf.demo
{
    ...
    public partial class Register : XncfRegisterBase, IXncfRegister
    {
        ...
        public override string Name => "christ.Xncf.demo";

        public override string Uid => "4B5AD90C-4BFE-48B7-AB16-66C1F531E657";//必须确保全局唯一，生成后必须固定，已自动生成，也可自行修改
        ...
        public override string Description => "fa fa--star";
        ...
        public override async Task UninstallAsync(IServiceProvider serviceProvider, Func<Task> unsinstallFunc)
        {
            ...
            demoSenparcEntities mySenparcEntities = serviceProvider.GetService(mySenparcEntitiesType) as demoSenparcEntities;
