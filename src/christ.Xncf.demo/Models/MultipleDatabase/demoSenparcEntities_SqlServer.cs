...
namespace christ.Xncf.demo.Models.DatabaseModel
{
    ...
    public class demoSenparcEntities_SqlServer : demoSenparcEntities
    {
        public demoSenparcEntities_SqlServer(DbContextOptions<demoSenparcEntities_SqlServer> dbContextOptions) : base(dbContextOptions)
        {
        }
    }
    ...
    /// <para>2、运行：PM> add-migration [更新名称] -c demoSenparcEntities_SqlServer -o Migrations/Migrations.SqlServer </para>
    /// </summary>
    public class SenparcDbContextFactory_SqlServer : SenparcDesignTimeDbContextFactoryBase<demoSenparcEntities_SqlServer, Register>
    {
