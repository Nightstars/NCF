...
namespace christ.Xncf.demo.Models.DatabaseModel
{
    ...
    public class demoSenparcEntities_MySql : demoSenparcEntities
    {
        public demoSenparcEntities_MySql(DbContextOptions<demoSenparcEntities_MySql> dbContextOptions) : base(dbContextOptions)
        {
        }
    }
    ...
    /// <para>2、运行：PM> add-migration [更新名称] -c demoSenparcEntities_MySql -o Migrations/Migrations.MySql </para>
    /// </summary>
    public class SenparcDbContextFactory_MySql : SenparcDesignTimeDbContextFactoryBase<demoSenparcEntities_MySql, Register>
    {
